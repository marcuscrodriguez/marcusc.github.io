...
* Calculated an average of 3.22% (=AVERAGE(E2:E24)) of murders occurring during a full moon over the period of 2001 to 2023 in the city of Chicago. Based on a synodic lunar month of 29.531 days the average percentage of full moon murders expected is 3.39%.  The mean of 3.22% calculated over the twenty-two year period is less than the expected average of 3.39%, indicating that the full moon does not lead to any extraordinary increase in the number of homicides.  
...
stdev <- sd(df[["percent"]])
margin_error <- qt(0.975,22)* stdev/sqrt(22)
...
### 5.(S)hare  
  ...
  *Based on the analysis of data covering twenty-two years, there are no increases in homicides that may be attributed to the full phase of the moon.  
  
### 6.(A)ct  
  
  *Based on the shared analysis, no action is necessary as it relates to staffing and emergency personnel requirements during a full moon as it does not impact the number of homicides.  
